...
namespace ATEM
{
    ...
    public static partial class ATEMMethods
    {
        ...
        public static T[] SubArray<T>(this T[] array, long startIndex)
        {
        ...
        /// <exception cref="ArgumentOutOfRangeException">startIndex plus length indicates a position not within this instance. -or- startIndex
        /// or length is less than zero.</exception>
        public static List<T> SubList<T>(this List<T> list, long startIndex, long length)
        {
        ...
        /// <exception cref="ArgumentOutOfRangeException">startIndex plus length indicates a position not within this instance. -or- startIndex
        /// is less than zero.</exception>
        public static List<T> SubList<T>(this List<T> list, long startIndex)
        {
